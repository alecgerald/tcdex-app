...
export default function ERGLayout({ children }: { children: React.ReactNode }) {
  const pathname = usePathname()
  const [isSidebarOpen, setIsSidebarOpen] = useState(true)
  const [openCategories, setOpenCategories] = useState<string[]>(["erg"])
  const username = "tcdexerg" // Role-specific placeholder

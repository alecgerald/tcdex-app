...
export default function ERGDirectoryPage() {
  ...
  const ergs = ["All", ...Array.from(new Set(members.map(m => m["Primary ERG"])))]
          ...
          {members.length === 0 ? (
            <div className="py-24 text-center space-y-4">
              ...
              <div>
                ...
                <p className="text-zinc-500 max-w-xs mx-auto">Upload the Membership Registry Excel file with the required columns to populate this view.</p>
              </div>
